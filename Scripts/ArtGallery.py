...
Polytri.py (for edge detection) by David Björkevik
mcoloring.py (for 3 coloring) by Divyanshu Mehta
PolygonVisibility.py (for Visibility in polygon) by Rushik Vartak & Yeshwanth Raja
Pygame Python Library (for User Interface)
Sympy Python Library (for solving equations - used for segment intersections)
EasyGui Python Library (for File open Dialog box)
